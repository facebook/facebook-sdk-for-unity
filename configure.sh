...
# Fix projects files
printf "\n"
declare -a projects=("Facebook.Unity" "Facebook.Unity.Settings" "Facebook.Unity.Gameroom" "Facebook.Unity.Android" "Facebook.Unity.Canvas" "Facebook.Unity.Editor" "Facebook.Unity.Tests" "UnitySDK")
